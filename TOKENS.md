...
| Messages | 437 |
| API calls | 490 |
| Input tokens | 686 520 |
| Output tokens | 680 108 |
| Of which reasoning | 374 314 |
| Cache read (cache_read) | 126 042 880 |
| Cache write (cache_write) | 0 |
| **Total (input + output)** | **1 366 628** |
| Estimated cost | ≈ 0.647 USD |
