...
| Messages | 437 |
| API calls | 526 |
| Input tokens | 728 560 |
| Output tokens | 721 151 |
| Of which reasoning | 391 706 |
| Cache read (cache_read) | 133 579 264 |
| Cache write (cache_write) | 0 |
| **Total (input + output)** | **1 449 711** |
| Estimated cost | ≈ 0.717 USD |
