...
| Messages | 437 |
| API calls | 516 |
| Input tokens | 721 265 |
| Output tokens | 713 750 |
| Of which reasoning | 388 407 |
| Cache read (cache_read) | 132 175 104 |
| Cache write (cache_write) | 0 |
| **Total (input + output)** | **1 435 015** |
| Estimated cost | ≈ 0.702 USD |
