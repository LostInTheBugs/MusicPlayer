...
`2026.08.036-c1` — see [CHANGELOG.md](CHANGELOG.md)
...
| Metric | Value |
|---|---|
| Input tokens | 3 137 919 |
| Output tokens | 2 102 833 |
| **Total (input + output)** | **5 240 752** |
| Cache read (reused at reduced price) | 391 187 328 |
| API calls | 1386 |
