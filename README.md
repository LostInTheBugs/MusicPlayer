...
`2026.08.028-c2` — see [CHANGELOG.md](CHANGELOG.md)
...
| Metric | Value |
|---|---|
| Input tokens | 2 257 447 |
| Output tokens | 1 723 607 |
| **Total (input + output)** | **3 981 054** |
| Cache read (reused at reduced price) | 312 061 056 |
| API calls | 1150 |
| **Estimated cost** | **≈ 1.56 USD** |
