...
`2026.08.027-c2` — see [CHANGELOG.md](CHANGELOG.md)
...
| Metric | Value |
|---|---|
| Input tokens | 2 171 468 |
| Output tokens | 1 638 368 |
| **Total (input + output)** | **3 809 836** |
| Cache read (reused at reduced price) | 291 873 536 |
| API calls | 1056 |
