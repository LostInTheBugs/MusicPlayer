...
`2026.08.027-c1` — see [CHANGELOG.md](CHANGELOG.md)
...
| Metric | Value |
|---|---|
| Input tokens | 1 991 253 |
| Output tokens | 1 514 847 |
| **Total (input + output)** | **3 506 100** |
| Cache read (reused at reduced price) | 287 068 672 |
| API calls | 1030 |
| **Estimated cost** | **≈ 1.43 USD** |
