...
`2026.08.023-c1` — see [CHANGELOG.md](CHANGELOG.md)
...
| Metric | Value |
|---|---|
| Input tokens | 1 689 496 |
| Output tokens | 1 226 101 |
| **Total (input + output)** | **2 915 597** |
| Cache read (reused at reduced price) | 237 772 032 |
| API calls | 861 |
| **Estimated cost** | **≈ 1.19 USD** |
