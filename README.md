...
`2026.08.037-c1` — see [CHANGELOG.md](CHANGELOG.md)
...
| Metric | Value |
|---|---|
| Input tokens | 3 664 071 |
| Output tokens | 2 172 204 |
| **Total (input + output)** | **5 836 275** |
| Cache read (reused at reduced price) | 444 468 224 |
| API calls | 1572 |
| **Estimated cost** | **≈ 2.22 USD** |
