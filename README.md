...
`2026.08.036-c8` — see [CHANGELOG.md](CHANGELOG.md)
...
| Metric | Value |
|---|---|
| Input tokens | 3 580 848 |
| Output tokens | 2 151 720 |
| **Total (input + output)** | **5 732 568** |
| Cache read (reused at reduced price) | 423 730 688 |
| API calls | 1514 |
| **Estimated cost** | **≈ 2.15 USD** |
